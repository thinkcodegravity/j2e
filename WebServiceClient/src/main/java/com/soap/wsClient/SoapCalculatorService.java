 ...
 * 
 */
@WebServiceClient(name = "SoapCalculatorService", targetNamespace = "http://demo.tutorial.com/", wsdlLocation = "http://localhost:7777/soap?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SOAPCALCULATORSERVICE_QNAME = new QName("http://demo.tutorial.com/", "SoapCalculatorService");
    ...
    public SoapCalculator getSoapCalculatorPort() {
        return super.getPort(new QName("http://demo.tutorial.com/", "SoapCalculatorPort"), SoapCalculator.class);
    }
    ...
    public SoapCalculator getSoapCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://demo.tutorial.com/", "SoapCalculatorPort"), SoapCalculator.class, features);
    }
